...
class ElasticsearchTaskHandler(FileTaskHandler, LoggingMixin):
    ...
    def __init__(self, base_log_folder, filename_template,
        ...
        self.log_id_jinja_template = None
        self.closed = False

        if "{{" in self.log_id_template:  # jinja mode
            self.log_id_jinja_template = Template(self.log_id_template)
    ...
    def close(self):
        ...
        # Reopen the file stream if it was accidentally closed.
